...
if ( ! class_exists( 'Advance_Ecommerce_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Advance_Ecommerce_Store_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Advance_Ecommerce_Store_WPTT_WebFont_Loader( $url );
